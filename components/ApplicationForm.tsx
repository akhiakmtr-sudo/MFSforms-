    ...
    const FileInput = ({ name, label, multiple = false, error }: { name: keyof FormFiles, label: string, multiple?: boolean, error?: string }) => (
        <div className="flex flex-col">
            ...
            <input
                ...
                className={`file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 text-slate-500 text-sm ${error ? 'border-red-500' : 'border-slate-300'}`}
            />
             ...
             <form onSubmit={handleSubmit} className="space-y-6 mt-6" noValidate>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value={formData.name} onChange={handleChange} required className={`mt-1 block w-full rounded-md border-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm bg-white text-black ${errors.name ? 'border-red-500' : 'border-black'}`} />
                     ...
                     <div>
                        ...
                        <input type="date" name="dob" id="dob" value={formData.dob} onChange={handleChange} required className={`mt-1 block w-full rounded-md border-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm bg-white text-black ${errors.dob ? 'border-red-500' : 'border-black'}`} />
                     ...
                     <div>
                        ...
                        <input type="tel" name="mobile" id="mobile" value={formData.mobile} onChange={handleChange} required className={`mt-1 block w-full rounded-md border-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm bg-white text-black ${errors.mobile ? 'border-red-500' : 'border-black'}`} />
                     ...
                     <div>
                        ...
                        <input type="email" name="email" id="email" value={formData.email} onChange={handleChange} required className={`mt-1 block w-full rounded-md border-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm bg-white text-black ${errors.email ? 'border-red-500' : 'border-black'}`} />
                     ...
                     <div>
                        ...
                        <input type="number" name="expectedSalary" id="expectedSalary" value={formData.expectedSalary} onChange={handleChange} required className={`mt-1 block w-full rounded-md border-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm bg-white text-black ${errors.expectedSalary ? 'border-red-500' : 'border-black'}`} />
                 ...
                 <div>
                    ...
                    <textarea name="bio" id="bio" rows={4} value={formData.bio} onChange={handleChange} required className={`mt-1 block w-full rounded-md border-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm bg-white text-black ${errors.bio ? 'border-red-500' : 'border-black'}`}></textarea>
                ...
                <div>
                     ...
                     <select name="hasRestrictions" id="hasRestrictions" value={formData.hasRestrictions} onChange={handleChange} className={`mt-1 block w-full rounded-md border-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm bg-white text-black ${errors.hasRestrictions ? 'border-red-500' : 'border-black'}`}>
                ...
                {formData.hasRestrictions === 'Yes' && (
                    <div>
                        ...
                        <textarea name="restrictionsReason" id="restrictionsReason" rows={3} value={formData.restrictionsReason} onChange={handleChange} className={`mt-1 block w-full rounded-md border-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm bg-white text-black ${errors.restrictionsReason ? 'border-red-500' : 'border-black'}`}></textarea>
                ...
                <div>
                    <button type="submit" disabled={!isSubmittable} className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-slate-400 disabled:cursor-not-allowed">
                        Submit Application
                    </button>
                </div>
            </form>
